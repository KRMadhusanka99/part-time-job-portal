...
var JobBoard = function(){
	...
	var homeSearch = function() {
		...
		quikSearch.on('click',function() {
			jQuery('..job-portal-quik-search').animate({'width': '100%' });
			jQuery('..job-portal-quik-search').delay(500).css({'left': '0'  });
		});
		
		quikSearchRemove.on('click',function() {
			jQuery('..job-portal-quik-search').animate({'width': '0%' ,  'right': '0'  });
			jQuery('..job-portal-quik-search').css({'left': 'auto'  });
		});	
